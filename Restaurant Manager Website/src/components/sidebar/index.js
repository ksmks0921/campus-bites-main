...
const navigation = [
  { name: "Home", href: "/serving", icon: HomesIcon, current: false },
  { name: "Past Order", href: "/past-orders/", icon: MenusIcon, current: false },
...
export default function Index() {
  ...
  return (
    <div className="flex overflow-hidden bg-gray-100 relative min-h-screen">
      ...
      <div className="hidden lg:flex md:flex-shrink-0 bg-primary">
