        ...
        <div className="md:grid lg:grid-cols-5 px-6 gap-4">
          ...
          <div className="lg:col-start-1 lg:col-end-5 w-full">
            ...
            <section className="md:flex gap-4">
              ...
              {/* text content here */}
              <div className="">
                <p className="text-[22px] md:text-[28px] leading-[40px] md:leading-[50px] mb-6 text-primary font-bold">
                ...
                {/* contact box */}
                <div
                  className="relative overflow-hidden bg-[#EBEBEB] rounded-[56px] px-4 md:px-8 py-6 mb-8 md:mb-4"
                  style={{
                    // background: "#EBEBEB",
                ...
                >
                  <div className="">
                    <div className="block md:flex justify-center gap-10 z-20">
                      <p className="text-center md:text-left text-[28px] leading-[26px] font-black text-primary mb-2 md:mb-0">
                        Questions?
                      </p>
                      <p className="text-center text-[18px] leading-[22px] font-bold text-secondary z-20">
                        Give Us A Shout!
                      </p>
                    </div>
                    <div className=" mt-5">
                      <div className="grid grid-cols-2 gap-x-4 md:gap-x-10 gap-y-8 ">
                        {/* Name */}
                        {/* <div className="z-10"> */}
                          <div className="mt-1 z-10 col-span-2 md:col-span-1 ">
                            <input
                              type="text"
                              name="name"
                              id="name"
                    ...
                    <div className="md:flex gap-3 col-span-2 items-center mt-5">
                      <div className="flex justify-start z-10">
                        <button className="bg-primary mx-auto md:mx-0 rounded-full w-[147px] h-[56px] inline-block  text-white font-bold z-[10]">
                          Send
                        </button>
                      </div>
                      <div className="flex-1 z-20 ">
                        <p className="text-[12px] leading-5 font-normal z-20 mt-2 md:mt-0">
                          {" "}
                  ...
                  <div className=" absolute -right-[20%] -top-[20%]   h-[393px] w-[393px] rounded-full hidden md:block bg-white z-0"></div>
                </div>
              </div>
            </section>
          </div>
