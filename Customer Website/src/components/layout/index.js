...
export default function Index({ children, ...rest }) {
  ...
  // if (name) {
  //   console.log(createInitials(name));
  // }
console.log("user info",userInfo.name)
console.log({name})
  return (
    <div className="relative">
      <div className="bg-primary flex justify-between z-[10] w-full md:hidden">
        {/* <div className="">
          <button
                          ...
                          <div className="flex flex-col justify-between">
                            ...
                            <div className="grid grid-cols-1 gap-4  my-2">
                              <div className="flex items-center w-full py-2">
                                <a
                                  href="/cart"
                                  className="no-underline flex items-center justify-center text-center w-full"
                                >
                                  <img src={CartIcon} alt="" className="" />
                                  <p className="text-[24px]  text-secondary">Cart</p>
                                </a>
                              </div>
                              ...
                              >
                                <a
                                  href="/profile"
                                  className="h-6 w-6 rounded-full bg-primary flex justify-center items-center text-white text-[16px] leading-[25px] font-bold px-6 py-6 mr-1"
                                >
                                ...
                                <div className="flex flex-col justify-start items-starts">
                                  ...
                                  <a
                                    href="/profile"
                                    className="text-primary text-left no-underline capitalize"
                                  >
      ...
      <div {...rest} className="">
        <div className="absolute top-0 w-full z-[6000] hidden md:block">
          <Navbar name={name} createInitials={createInitials}/>
        </div>
        <div className="">
