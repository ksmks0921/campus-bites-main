...
const SignupQuestion2 = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flex: 1, top: 60, alignItems: 'center'}}>
        <Circle question="You are an independent contractor. You can work as little or as much as you choose, and can stop working with CampusBites at any time." />
        <Text
          style={{
            top: 10,
            fontWeight: 'bold',
      ...
      <View
        ...
        <TouchableOpacity style={styles.loginBtn}>
          <Text
            ...
            onPress={() => navigation.navigate('SignupQuestion3')}>
            Yes
          </Text>
        </TouchableOpacity>
      </View>
...
export default SignupQuestion2;
