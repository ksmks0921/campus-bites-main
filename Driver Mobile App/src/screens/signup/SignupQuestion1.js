...
const SignupQuestion1 = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flex: 1, top: 60, alignItems: 'center'}}>
        <Circle
          question="You will be a 1099 independent Contractor for CampusBites, 
          LLC And will be responsible for paying your taxes on income earned through CampusBites?"
        />
        <Text
          style={{
            top: 10,
